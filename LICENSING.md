...
A `LICENSE-dtm` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [dtm-labs/dtm](https://github.com/dtm-labs/dtm), Copyright
2021, yedf, licensed under BSD-3-Clause. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../dtm-port/specs/SPEC-001-dtm.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
